...
import {getWebhookMessageCallback} from "./webhooks";
import {getOAuthToken, refreshToken} from "./request";
import {SequelizeTwitchWebhookPersistenceManager} from "./db/models/webhook";
...
sequelize.sync().then(() => {
    ...
    let webhookManager: TwitchWebhookManager = new TwitchWebhookManager({
        ...
        persistenceManager: new SequelizeTwitchWebhookPersistenceManager(sequelize),
